...
class StochasticPolicyGradientGradAgg(updaters.StochasticPolicyGradient):
    def __init__(self, *args, agg=None, **kwargs):
        super(StochasticPolicyGradientGradAgg, self).__init__(*args, **kwargs)
        self.agg = agg
...
class ClippedRatioGradAgg(updaters.ClippedRatio):
    def __init__(self, optimizer=None, ratio_clip=0.2, kl_threshold=0.015, entropy_coeff=0, gradient_clip=0,
                 agg=None):
        super(ClippedRatioGradAgg, self).__init__(optimizer=optimizer, ratio_clip=ratio_clip, kl_threshold=kl_threshold,
...
class TrustRegionPolicyGradientGradAgg:
    def __init__(self, optimizer=None, entropy_coeff=0, agg=None):
...
class TwinCriticSoftDeterministicPolicyGradientGradAgg:
    def __init__(self, optimizer=None, entropy_coeff=0.2, gradient_clip=0, agg=None):
        self.optimizer = optimizer or (
